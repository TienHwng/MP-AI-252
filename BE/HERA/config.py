...
CALENDAR_SEARCH_ENABLED = env_bool("CALENDAR_SEARCH_ENABLED", False)
GOOGLE_CALENDAR_CREDENTIALS_PATH = os.getenv("GOOGLE_CALENDAR_CREDENTIALS_PATH")
GOOGLE_CALENDAR_ID = os.getenv("GOOGLE_CALENDAR_ID", "primary")
CALENDAR_CACHE_TTL_SECONDS = env_int("CALENDAR_CACHE_TTL_SECONDS", 1800)
...
PRICE_SEARCH_ENABLED = env_bool("PRICE_SEARCH_ENABLED", True)
PRICE_CACHE_TTL_SECONDS = env_int("PRICE_CACHE_TTL_SECONDS", 300)
PRICE_DEFAULT_CURRENCY = os.getenv("PRICE_DEFAULT_CURRENCY", "usd")

PLACES_SEARCH_ENABLED = env_bool("PLACES_SEARCH_ENABLED", True)
PLACES_CACHE_TTL_SECONDS = env_int("PLACES_CACHE_TTL_SECONDS", 86400)
PLACES_USER_AGENT = os.getenv("PLACES_USER_AGENT", "HERA-IoT/1.0")
