...
class ToolRegistry:
	...
	def register_builtins(self) -> None:
		...
		self.executors["turn_on_led"] = lambda args: set_device_state(
			{"device_target": "main_led"}, True
		)
		self.executors["turn_off_led"] = lambda args: set_device_state(
			{"device_target": "main_led"}, False
		)
		self.executors["turn_on_neo_led"] = lambda args: set_device_state(
			{"device_target": "neo_led"}, True
		)
		self.executors["turn_off_neo_led"] = lambda args: set_device_state(
			{"device_target": "neo_led"}, False
		)
		self.executors["turn_on_all_lights"] = lambda args: set_device_state(
			{"device_target": "all_lights"}, True
		)
		self.executors["turn_off_all_lights"] = lambda args: set_device_state(
			{"device_target": "all_lights"}, False
		)
		self.executors["turn_on_fan"] = lambda args: set_device_state(
			{"device_target": "mini_fan"}, True
		)
		self.executors["turn_off_fan"] = lambda args: set_device_state(
			{"device_target": "mini_fan"}, False
		)
