...
from web_search.calendar_client import GoogleCalendarService
...
from web_search.places_client import NominatimPlacesService
from web_search.price_client import PriceSearchService
