...
|
|-- backend/                     # Backend, AI runtime, and data services
...
\begin{itemize}
  ...
  \item \textbf{backend/}: backend and AI service layer. This area contains the multi-agent assistant, MQTT infrastructure, database/API service, and Telegram utilities.
    \begin{itemize}
  ...
  \item \textbf{frontend/}: frontend workspace for the user-facing dashboard.
    \begin{itemize}
