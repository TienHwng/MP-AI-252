...
The digital twin is implemented in the React dashboard under \texttt{frontend/hera-dashboard}. The core component is \texttt{FloorPlan.jsx}. It renders the house floor-plan image, overlays device and sensor markers at fixed percentage coordinates, subscribes to live telemetry, and updates the marker state whenever new data arrives.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{content/content/house interior.png}
